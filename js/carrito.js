...
function vaciarCarrito() {
  ...
  Toastify({
    ...
    close: true, // Muestra un botón para cerrar
    gravity: "top", // `top` o `bottom`
    position: "center", // `left`, `center`, o `right`
    backgroundColor: "linear-gradient(to right, #00b09b, #96c93d)", // Fondo con degradado
    className: "info",
    stopOnFocus: true, // Detiene el temporizador al pasar el mouse
    onClick: function(){} // Función al hacer clic en la notificación
}).showToast();
}
// Se actualiza el total.
